    ...
    private fun loadMockData() {
        viewModelScope.launch {
            _scannedItems.value = listOf( // Right now just test items
                ...
                ScannedItem("Protein Shake", "Muscle Fuel", 150, 25, 6, 2, "A-"),
                ScannedItem("Greek Yogurt", "YogurtLand", 100, 10, 7, 3, "A"),
                ScannedItem("Dark Chocolate", "Cocoa Bliss", 170, 2, 12, 14, "B"),
                ScannedItem("Almond Milk", "Nutty Farms", 60, 1, 8, 3, "A"),
                ScannedItem("Oatmeal Cookies", "Grandma's Bakes", 180, 3, 22, 9, "B-")
            )
        }
    }
