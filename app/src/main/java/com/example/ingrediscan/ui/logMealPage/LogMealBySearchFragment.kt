...
import com.example.ingrediscan.ui.search.SearchViewModel
...
class LogMealBySearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        searchTitleTextView.text = "Search To Log A Meal"
        Log.d("LogMealBySearchFragment", "SearchView: ${binding.searchView}")
        return root
    }
